        ...
        web::scope(base_url)
            ...
            .service(
                web::scope("role")
                    ...
                    .service(
                        web::scope("permission")
                            .service(get_manager_role_permissions)
                            .service(change_role_permission_status),
                    )
                    .service(
                        web::scope("router")
                            .service(get_manager_role_router)
                            .service(change_role_router_status)
                            .service(get_current_role_router),
                    ),
            )
            .service(
                web::scope("managers")
