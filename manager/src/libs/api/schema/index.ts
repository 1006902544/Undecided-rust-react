...
export * from './deleteGameDetailReq';
...
export * from './gameSPUDetail';
export * from './gameSPUDetailCompany';
export * from './gameSPULimit';
...
export * from './getGameDetailReq';
export * from './getGameLimitReq';
